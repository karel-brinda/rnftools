...
+--------------+-------------------------------------------------------------------------+
| Remarks:     | **Format of original read names**                                       |
|              |                                                                         |  
|              | 	.. code-block::                                                  |
|              |                                                                         | 
...
|              | 	6)  random read end 1 (0 - from the mutated reference,           |
|              |		1 - random)                                              |
|              | 	7)  random read end 2 (0 - from the mutated reference,           |
|              |		1 - random)                                              |
|              | 	8)  number of sequencing errors end 1 (color errors for          |
|              |		colorspace)                                              |
|              | 	9)  number of SNPs end 1                                         | 
|              | 	10) number of indels end 1                                       |
|              | 	11) number of sequencing errors end 2 (color errors for          |
|              |		colorspace)                                              |
